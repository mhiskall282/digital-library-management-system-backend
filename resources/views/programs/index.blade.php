...
<div class="space-y-6" x-data="{ selectedProgram: '{{ array_key_first($programsCatalog) ?? '' }}', selectedLevel: 'L100' }">
    ...
    @else
        ...
        <div class="bg-white rounded-3xl p-12 text-center border border-slate-200 shadow-xs space-y-4">
            ...
            <h3 class="text-lg font-bold text-slate-900">Academic Catalog Synchronizing</h3>
            <p class="text-xs text-slate-500 max-w-md mx-auto leading-relaxed">
                The academic programs catalog is synchronizing with the central repository. You can explore all available course slides and past exams directly in the Catalog Explorer.
            </p>
            <div class="pt-2">
                <a href="{{ route('dashboard') }}" class="inline-flex items-center space-x-2 px-5 py-2.5 rounded-xl bg-uew-scarlet text-white font-bold text-xs shadow-xs hover:bg-uew-scarlet-hover transition">

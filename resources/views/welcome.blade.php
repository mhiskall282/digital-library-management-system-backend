                ...
                <div class="flex items-center space-x-3">
                    @auth
                        @if(auth()->user()->isAdmin())
                            <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 rounded-xl bg-uew-navy text-white text-xs font-bold shadow-xs hover:bg-uew-navy-hover transition">
                                Command Center &rarr;
                            </a>
                        @else
                            <a href="{{ route('student.hub') }}" class="px-4 py-2 rounded-xl bg-uew-scarlet text-white text-xs font-bold shadow-xs hover:bg-uew-scarlet-hover transition">
                                My Study Hub &rarr;
                            </a>
                        @endif
                    @else
                        <a href="{{ route('login') }}" class="px-3.5 py-2 text-xs font-bold text-slate-700 hover:text-uew-scarlet transition">
                            Sign In
                        </a>
                        <a href="{{ route('register') }}" class="px-4 py-2 rounded-xl bg-uew-scarlet text-white text-xs font-bold shadow-md shadow-red-700/20 hover:bg-uew-scarlet-hover transition">
                            Register Index No.
                        </a>
                    @endauth
                </div>
